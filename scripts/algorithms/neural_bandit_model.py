...
from scripts.core.bayesian_nn import BayesianNN
...
class NeuralBanditModel(BayesianNN):
    ...
    def __init__(self, optimizer, hparams, output_folder, name):
          ...
          # create and store a new session for the graph
            ...
            with tf.name_scope(self.name):
                ...
                self.summary_writer = tf.summary.FileWriter(
                    "{}/graph_{}".format(self.output_folder, self.name), self.sess.graph)
